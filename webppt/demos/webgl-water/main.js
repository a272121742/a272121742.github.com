...
function handleError(text) {
  ...
  var loading = document.getElementById('WebGL_Wather_Loading');
...
function showWebGLWater() {
  var ratio = window.devicePixelRatio || 1;
  var help = document.getElementById('WebGL_Water');
  ...
  document.getElementById('WebGL_Water_Loading').innerHTML = '';
  onresize();
